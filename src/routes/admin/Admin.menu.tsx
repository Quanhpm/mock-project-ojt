...
export const ADMIN_MENU: AdminMenuItem[] = [
  ...
  },
  {
    ...
    path: `${ROUTER_URL.ADMIN_ROUTER.PROMOTION}/create`,
    icon: <Ticket size={18} />,
    component: React.lazy(() => import("@/modules/admin/promotion-management/components/PromotionCreateModal")),
    module: "promotions",
    hideFromSidebar: true,
  },
  ...
  {
    label: "POS Review",
    path: ROUTER_URL.ADMIN_ROUTER.ORDER_POS_REVIEW,
    icon: <ShoppingCart size={18} />,
    component: React.lazy(() => import("@/modules/admin/order-management/pages/OrderPosReviewPage")),
    module: "orders",
    hideFromSidebar: true,
    allowedRoles: ["ADMIN", "MANAGER", "STAFF"],
  },
