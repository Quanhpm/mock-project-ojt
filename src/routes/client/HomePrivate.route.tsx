...
export const HomePrivateRoutes = (
  <Route element={<ClientGuard />}>
    <Route element={<HomeLayout />}>
      ...
      <Route path={ROUTER_URL.HOME_ROUTER.CART} element={<div className="container mx-auto p-8"><h1 className="text-3xl font-bold">Cart Page</h1></div>} />
      ...
      <Route path={ROUTER_URL.HOME_ROUTER.ORDER_HISTORY} element={<div className="container mx-auto p-8"><h1 className="text-3xl font-bold">Order History Page</h1></div>} />
