...
type Module = 'dashboard' | 'users' | 'franchise' | 'products' | 'categories' | 'inventory' | 'vouchers' | 'promotions'| 'loyalty-rules' | 'customers' | 'orders' | 'shifts' | 'select-franchise';

export const ROLE_PERMISSIONS: Record<RoleCode, Module[]> = {
  ADMIN: ['dashboard', 'users', 'franchise', 'products', 'categories', 'inventory', 'vouchers', 'promotions', 'loyalty-rules', 'customers', 'orders', 'shifts', 'select-franchise'],
  MANAGER: ['dashboard', 'products', 'categories', 'inventory', 'vouchers', 'promotions', 'loyalty-rules', 'customers', 'orders', 'shifts', 'select-franchise'],
