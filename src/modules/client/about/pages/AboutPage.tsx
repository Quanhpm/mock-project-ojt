...
function AboutPage() {
  ...
  return (
    <div>
      {/* ABOUT + BRAND DNA */}
      <section id="about" ref={aboutSection.ref} className="py-24 px-4">
        <div className="max-w-screen-xl mx-auto">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24 transition-all duration-1000 ${aboutSection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div>
              <span className="text-[var(--cf-secondary)] uppercase tracking-[0.2em] text-xs font-semibold block mb-3">Về chúng tôi</span>
              <h2 className="text-4xl md:text-5xl font-black text-[var(--cf-primary)] leading-tight mb-6">
                Về <span className="text-[var(--cf-secondary)]">Boutique Brews</span>
              </h2>
              <p className="text-[var(--cf-primary)]/75 text-lg leading-relaxed mb-5">
              ...
              <div className="flex items-center gap-8 mt-8">
                {[['8+', 'Năm kinh nghiệm'], ['50+', 'Loại cà phê'], ['10k+', 'Khách hàng']].map(([num, label]) => (
                  <div key={label} className="text-center">
                    <p className="text-3xl font-black text-[var(--cf-primary)]">{num}</p>
            ...
            <div className="relative">
              <img
                ...
                alt="Boutique Brews"
              />
              <div className="absolute -bottom-5 -left-5 bg-[var(--cf-primary)] text-white px-6 py-4 rounded-xl shadow-xl">
                <p className="text-2xl font-black">2016</p>
          ...
          <div className={`transition-all duration-1000 delay-200 ${aboutSection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h3 className="text-center text-2xl md:text-3xl font-black text-[var(--cf-primary)] uppercase tracking-wider mb-10">Nền tảng tạo nên Boutique Brews</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {BRAND_DNA.map(item => (
                <div key={item.title} className="group bg-white/60 hover:bg-white/90 border border-[var(--cf-secondary)]/20 hover:border-[var(--cf-secondary)]/50 p-7 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300">
      ...
      {/* JOURNEY */}
      <section ref={journeySection.ref} className="py-24 px-4">
        <div className={`max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center transition-all duration-1000 ${journeySection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="relative">
            <img
          ...
          <div>
            ...
            <h2 className="text-4xl font-black text-[var(--cf-primary)] mb-6 leading-tight">
              Từ nông trại vùng cao <br/>đến tách cà phê mỗi sáng
            </h2>
            <p className="text-[var(--cf-primary)]/75 leading-relaxed mb-8 text-lg">
