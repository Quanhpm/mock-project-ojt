    ...
    <header className="w-full px-8 py-6 flex flex-col gap-6 shrink-0 z-10">
      <div className="flex flex-col gap-1">
        <nav className="flex items-center gap-2 text-sm text-slate-500">
          ...
          <span className="text-slate-900 font-medium">Shifts</span>
        </nav>
      </div>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-slate-500">Total Assignments: {totalAssignments}</p>
        </div>
        <button
        ...
        >
          ...
          <span className="font-bold text-sm">Create Assignment</span>
        </button>
      </div>
    </header>
  )
