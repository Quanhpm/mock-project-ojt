...
const DroppableDayCell: React.FC<DroppableDayCellProps> = ({
  ...
  return (
    <div
      ...
      className={[
        'relative h-full min-h-[100px] border-b border-r border-slate-200 text-left last:border-r-0 focus:outline-none transition-colors',
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md rounded-2xl bg-white p-5 shadow-2xl ring-1 ring-slate-200"
      >
