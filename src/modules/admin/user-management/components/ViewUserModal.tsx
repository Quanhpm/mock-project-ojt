...
export const ViewUserModal: React.FC<ViewUserModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden border border-gray-100">
                {/* ═══════════ Header ═══════════ */}
                ...
                {/* ═══════════ Content ═══════════ */}
                <div className="overflow-y-auto bg-gray-50/50 flex-1 p-6">
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        {error ? (
                            <div className="p-6 flex flex-col items-center justify-center text-center gap-2">
                                ...
                                <button
                                    onClick={() => getUserFranchiseRoles(user.id).then(d => { setRoles(d || []); setError(null) })}
