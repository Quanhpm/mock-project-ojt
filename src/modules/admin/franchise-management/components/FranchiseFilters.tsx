...
export const FranchiseFilters: React.FC<FranchiseFiltersProps> = ({
  searchTerm,
  statusFilter,
  onSearchChange,
  onStatusChange,
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex gap-3 overflow-x-auto pb-1 md:pb-0">
          ...
          <button
            ...
            className="text-sm font-medium text-primary hover:text-blue-600 px-2 whitespace-nowrap cursor-pointer"
          >
            Clear Filters
          </button>
        </div>
