                  ...
                  <nav aria-label="Pagination" style={{ display: "inline-flex", borderRadius: "8px", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
                    ...
                    {(() => {
                      ...
                      return pages.map((page, idx) =>
                        page === "..." ? (
                          <span key={`e-${idx}`} style={{ padding: "8px 4px", fontSize: "14px", color: "#6b7280" }}>...</span>
                        ) : (
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "6px", marginLeft: "12px" }}>
                      ...
                      <input
                        ...
                        style={{ width: "52px", height: "34px", border: "1px solid #dee2e6", borderRadius: "6px", textAlign: "center", fontSize: "14px", outline: "none", padding: "0 4px" }}
                      />
                    </div>
                  </nav>
                </div>
